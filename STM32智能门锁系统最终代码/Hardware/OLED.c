...
{
	GPIO_WriteBit(GPIOB, GPIO_Pin_13, (BitAction)BitValue); // PB13 → PB15
	//...
}
...
{
	GPIO_WriteBit(GPIOB, GPIO_Pin_15, (BitAction)BitValue); // PB13 → PB15
	//...
}
...
void OLED_GPIO_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13; // PB8 → PB13
 	GPIO_Init(GPIOB, &GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15; // PB9 → PB15
 	GPIO_Init(GPIOB, &GPIO_InitStructure);
